...
class TestValidParams(BaseAppTestCase):
    ...
    def setUp(self):
        ...
        a1 = Answer(message="Message 1", question=self.q1, user=u1)
        a2 = Answer(message="Message 1", question=self.q1, user=u1)
        a3 = Answer(message="Message 1", question=self.q1, user=u1)
        self.db.add(u1)
        self.db.add(self.q1)
        self.db.add(self.q2)
        self.db.add(a1)
